...
<div class="container">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="personalitymatching-tab" data-toggle="tab" href="#personalitymatching"
                role="tab" aria-controls="personalitymatching" aria-selected="true">PersonalityMatching</a>
        </li>
        <li class="nav-item">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="personalitymatching" role="tabpanel"
            aria-labelledby="personalitymatching-tab">
