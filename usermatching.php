...
<div class="tab-content" id="myTabContent">
 ...
 <br>
   ...
   $perosnalityfullsql="";
 if(!empty($_GET["scp"])){
$perosnality=$_GET["scp"];
$_SESSION["savescp"]=$perosnality;
$perosnalityfullsql="WHERE `personality` = '$perosnality'";
}
...
$age = date_diff(date_create($birthDate), date_create($currentDate));
 ...
 ?>
    ...
    <!-- <?php 
       ...
       if($page>1) 
       {
          echo "<a href='usermatching.php?page=".($page-1)."&?scp=".$_SESSION["savescp"]."' class='btn btn-danger'>PREVIOUS</a>";
       }

       for($i = 1; $i < $total_page + 1; $i++) 
       {
         if($i==$page){
          echo "<a href='usermatching.php?page=".$i."&?scp=".$_SESSION["savescp"]."'class='btn btn-outline-primary'>$i</a></li>";
           }else{
               echo "<a href='usermatching.php?page=".$i."&?scp=".$_SESSION["savescp"]."' class='btn btn-primary'>$i</a>";
           }
       }

       if($i-1>$page) 
       {
          echo "<a href='usermatching.php?page=".($page+1)."&?scp=".$_SESSION["savescp"]."' class='btn btn-danger'>NEXT</a>";
       }
       unset($_SESSION['savescp']);
?> -->
</center>
