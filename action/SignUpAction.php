...
if (isset($_POST['email']))
{
    ...
    if($firstname=="")
        ...
        elseif($gender=="")
            {
                echo '<script type="text/javascript">';
                echo 'alert("Password input gender");';
                 echo 'window.location = "../signup.php";';
                echo '</script>';
            }
    ...
    if (mysqli_num_rows($rs) > 0)
                {
                    ...
                    $status = "Not Activate";
                    $sql = "INSERT INTO userinfo (firstname, lastname, email, gender, birth, password, status) VALUES ('$firstname', '$lastname', '$email', '$gender', '$birth','$sha512psw','$status')";
